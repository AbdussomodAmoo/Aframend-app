...
# =============================================================================
# USAGE EXAMPLE - ADD TO YOUR MAIN STREAMLIT APP
# =============================================================================

# In your main() function, after displaying the tabular results, add:
"""
# Add this after your existing results display
if len(valid_results) > 0:
