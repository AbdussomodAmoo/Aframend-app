...
def load_model():
    ...
    try:
        with gzip.open('models/african_phytochemical_toxicity_models.pkl.gz', 'rb') as f:
            model = pickle.load(f)
        return model
    except FileNotFoundError:
        st.error("Model file not found. Please ensure 'african_phytochemical_toxicity_models.pkl.gz' is in the correct directory.")
        return None
